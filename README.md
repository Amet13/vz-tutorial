...
![Общая схема взаимодействия виртуализации с аппаратурой и программным обеспечением](https://github.com/Amet13/virtuozzo-tutorial/blob/master/images/virt-scheme.png)
...
![Схема эмуляции оборудования](https://github.com/Amet13/virtuozzo-tutorial/blob/master/images/emulation.png)
...
![Схема полной виртуализации](https://github.com/Amet13/virtuozzo-tutorial/blob/master/images/full-virt.png)
...
![Схема паравиртуализации](https://github.com/Amet13/virtuozzo-tutorial/blob/master/images/paravirt.png)
...
![Схема виртуализации уровня ОС](https://github.com/Amet13/virtuozzo-tutorial/blob/master/images/cont-virt.png)
...
![Время отклика системы](https://github.com/Amet13/virtuozzo-tutorial/blob/master/images/response-time.png)
...
![Пропускная способность сети](https://github.com/Amet13/virtuozzo-tutorial/blob/master/images/network.png)
