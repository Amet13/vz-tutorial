# Руководство по созданию и управлению контейнерами и виртуальными машинами на базе Virtuozzo/OpenVZ 7
...
Дистрибутив Virtuozzo Linux (VzLinux) с патчами для ядра RHEL 7, утилитами управления и модифицированным установщиком доступен для скачивания в виде стандартного ISO-образа с доступными локально пакетами и в виде netinstall-образа.
...
![Экран установки OpenVZ](https://raw.githubusercontent.com/Amet13/virtuozzo-tutorial/master/images/vz-install/install-vz.png)
...
*Пример разметки для 23GB диска*
