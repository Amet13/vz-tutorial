...
![Общая схема взаимодействия виртуализации с аппаратурой и программным обеспечением](images/virt-scheme.png)
...
![Схема эмуляции оборудования](images/emulation.png)
...
![Схема полной виртуализации](images/full-virt.png)
...
![Схема паравиртуализации](images/paravirt.png)
...
![Схема виртуализации уровня ОС](images/cont-virt.png)
