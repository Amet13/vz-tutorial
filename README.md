...
6. [Управление контейнерами](#-Управление-контейнерами)
  ...
  - [Переустановка контейнера](#Переустановка-контейнера)
...
## [⬆](#Содержание) Введение в виртуализацию
...
## [⬆](#Содержание) Краткая история проекта Virtuozzo
...
## [⬆](#Содержание) Установка и подготовительные действия
...
## [⬆](#Содержание) Управление шаблонами гостевых ОС
...
## [⬆](#Содержание) Создание и настройка контейнеров
...
## [⬆](#Содержание) Управление контейнерами
...
## [⬆](#Содержание) Управление ресурсами
...
## [⬆](#Содержание) Миграция контейнеров
