...
Каждый контейнер имеет свой конфигурационный файл, который хранится в каталоге `/vz/private/$UUID/ve.conf`.
...
Для удобства использования конфигов, для них созданы символические ссылки в каталоге вида `/etc/vz/conf/$UUID.conf`.

Для большего удобства использования использования конфигов, также существуют символические ссылки вида `/etc/vz/names/$NAME`.
